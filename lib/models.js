...
export const UNITS = ['sheets', 'reams', 'rolls', 'metres', 'sqm', 'litres', 'pieces', 'packs'];
...
const PriceItemSchema = new Schema(
  {
    ...
    description: String,
    unitLabel: { type: String, default: 'per unit' }, // "per 100", "per sqm", "per piece"
    price: { type: Number, required: true, min: 0 },
    estimatedCost: { type: Number, default: 0 }, // owner-only; feeds the profit estimate
...
const JobSchema = new Schema(
  {
    ...
    specs: {
      size: String,
      paper: String,
      colour: String, // "Full colour", "Black only", "2 colour"...
      finishing: String,
      sides: String, // "Single sided" / "Double sided"
    },
...
const SettingsSchema = new Schema(
  {
    ...
    businessName: { type: String, default: 'My Printing Press' },
    address: String,
    phone: String,
    email: String,
